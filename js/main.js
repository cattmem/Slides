...
if($.browser.mozilla) {
  $("body").prepend("<div style="width:100%;height:50px;background:#0066FF;display-box;border-box;border-bottom-left-radius:10px;border-bottom-right-radius:10px">
    <p style="padding-left:15px;padding-top:15px;color:#fff;font-weight:600;">Вы используете старую версию браузера! <span style="font-weight:200;opacity:.9;">Многие объекты могут отображаться неправильно, попробуйте <a style="border-bottom: solid 1px #fff" href='https://support.mozilla.org/ru/kb/obnovlenie-firefox-do-poslednego-vypuska'>проверить обновления для вашего браузера</a></span></p>
</div>");
} elif($.browser.opera) {
  $("body").prepend("<div style="width:100%;height:50px;background:#0066FF;display-box;border-box;border-bottom-left-radius:10px;border-bottom-right-radius:10px">
    <p style="padding-left:15px;padding-top:15px;color:#fff;font-weight:600;">Вы используете старую версию браузера! <span style="font-weight:200;opacity:.9;">Многие объекты могут отображаться неправильно, попробуйте <a style="border-bottom: solid 1px #fff" href='https://www.opera.com/ru/browsers/opera'>проверить обновления для вашего браузера</a></span></p>
</div>");
} elif($.browser.webkit) {
  $("body").prepend("<div style="width:100%;height:50px;background:#0066FF;display-box;border-box;border-bottom-left-radius:10px;border-bottom-right-radius:10px">
    <p style="padding-left:15px;padding-top:15px;color:#fff;font-weight:600;">Вы используете старую версию браузера! <span style="font-weight:200;opacity:.9;">Многие объекты могут отображаться неправильно, попробуйте <a style="border-bottom: solid 1px #fff" href='https://support.google.com/chrome/answer/95414?hl=ru&co=GENIE.Platform%3DDesktop'>проверить обновления для вашего браузера</a></span></p>
</div>");
}
